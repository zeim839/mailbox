...
var deleteCmd = &cobra.Command{
	Use:   "delete [id]",
	Short: "Delete a contact form submission",
	Long: `Delete a contact form submission by its ID. If the document
is found, it is deleted. Otherwise, an error is returned.`,
